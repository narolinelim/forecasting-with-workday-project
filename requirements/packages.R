...
REQUIRED_PACKAGES <- c("shiny", "bslib", "DT", "dplyr", "readxl", "openxlsx", "tidyr", "rmarkdown", "shinyjs", "tinytex", "RColorBrewer", "palmerpenguins", "shinyWidgets", "sortable", "ggplot2", "plotly")
